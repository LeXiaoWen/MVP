//package cree.mvp.ui.zoom.common.adapter;
//
...
//        final View view = LayoutInflater.from(mContext).inflate(R.layout.zoomable_view_pager_item, null);
//        Button button = (Button) view.findViewById(R.id.b_test);
//        final ZoomableDraweeView zoomableDraweeView = (ZoomableDraweeView) view.findViewById(R.id.zoomable_image);
//        //允许缩放时切换
