...
import cree.mvp.ui.zoom.common.gestures.TransformGestureDetector;
...
public class AnimatedZoomableController extends AbstractAnimatedZoomableController {
    ...
    public void setTransform(Matrix newTransform, long durationMs, @Nullable Runnable onAnimationComplete) {
        super.setTransform(newTransform, durationMs, onAnimationComplete);
        if (mDoubleClickZoomListener != null) {
            mDoubleClickZoomListener.onZoomPoint(ZoomableDraweeView.createPointBean(newTransform));
        }
    }

    private DoubleClickZoomListener mDoubleClickZoomListener;

    public DoubleClickZoomListener getDoubleClickZoomListener() {
        return mDoubleClickZoomListener;
    }

    public void setOnDoubleClickZoomListener(DoubleClickZoomListener doubleClickZoomListener) {
        mDoubleClickZoomListener = doubleClickZoomListener;
    }

    /**
     * 双击回响事件
     */
    public interface DoubleClickZoomListener {
